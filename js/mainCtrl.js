...
$scope.getSongData = function() {
  itunesService.getArtistName($scope.artist).then(function(serviceResponse) {
    var formattedArr = [];
    serviceResponse.forEach(function(element) {
      formattedArr.push({
        AlbumArt: element.artworkUrl30,
